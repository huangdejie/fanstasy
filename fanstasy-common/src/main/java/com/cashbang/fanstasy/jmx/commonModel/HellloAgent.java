package com.cashbang.fanstasy.jmx.commonModel;
...
/**
 * @Author: huangdejie
 * @Date: 2018/9/7 0007 下午 2:06
 */
public class HellloAgent {

    public static void main(String[] args) throws Exception{
        // 需要将xml信息读入到Registry对象中
        Registry registry = Registry.getRegistry(null,null);
        InputStream stream = HellloAgent.class.getResourceAsStream("/mbean-desc.xml");
